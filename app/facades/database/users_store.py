...
def add_exchangeable_token_amount(
    user_id: str, exchangeable_amount: int
) -> int:
    """トークンを追加する
    ...
    balance = user.total_exchangeable_token + exchangeable_amount
    user.total_exchangeable_token = balance
